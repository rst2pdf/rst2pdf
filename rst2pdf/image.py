...
class MyImage(Flowable):
    ...
    def support_warning(cls):
        ...
        cls.warned = True
        log.warning(
            "Support for images other than JPG," " is now limited. Please install PIL."
        )
        ...
        if extension in ["svg", "svgz"]:
            ...
            # looks decent
                ...
                log.warning(
                    ...
                    "requires PythonMagick or the vectorpdf extension [%s]",
                    filename,
                )
                filename = missing
            ...
            if LazyImports.PMImage:
                ...
                log.error(
                    "To use a %s image you need PIL installed [%s]", extension, filename
                )
                filename = missing
