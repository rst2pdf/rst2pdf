...
from reportlab.lib.colors import Color, CMYKColor, getAllNamedColors, toColor, HexColor
...
if HAS_XHTML2PDF:
    ...
    def getColor2(value, default=None):
        ...
        if value.startswith("#") and len(value) == 4:
            value = "#" + value[1] + value[1] + value[2] + value[2] + value[3] + value[
                3
            ]
    ...
    def pisaPreLoop2(node, context, collect=False):
        ...
        if node.nodeType == Node.TEXT_NODE and collect:
            ...
            if name in ("style", "link"):
                ...
                if (
                    attr.get("type", "").lower() in ("", "text/css")
                    and (
                        not media
                        or "all" in media
                        or "print" in media
